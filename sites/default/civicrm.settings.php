...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupaluser:@127.0.0.1:33067/publicevents?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://drupaluser:@127.0.0.1:33067/publicevents?new_link=true');
}
...
$civicrm_root = 'C:/DevDesktop-sites/drupal-7.43/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:/DevDesktop-sites/drupal-7.43\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://publicevents.dd:8083/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'efec3fb7ca8f66803bf96e6685215d20');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:/DevDesktop-sites/drupal-7.43\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
